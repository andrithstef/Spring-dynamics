...
public:
  Spring(float length, float K, const sf::Vector2f &p1, const sf::Vector2f &p2,
...
private:
  ...
  const sf::Vector2f &m_p1; // connection point 1
  const sf::Vector2f &m_p2; // connection point 2
